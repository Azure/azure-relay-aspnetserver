...
{
    public class OpaqueUpgradeTests : IClassFixture<LaunchSettingsFixture>
    {
        private readonly LaunchSettingsFixture launchSettingsFixture;

        public OpaqueUpgradeTests(LaunchSettingsFixture launchSettingsFixture)
        {
        ...
        // Read the response headers, fail if it's not a 101
        private async Task ParseResponseAsync(Stream stream)
        {
