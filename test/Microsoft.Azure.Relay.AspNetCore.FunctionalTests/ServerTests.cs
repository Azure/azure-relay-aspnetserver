...
{
    public class ServerTests : IClassFixture<LaunchSettingsFixture>
    {
        public LaunchSettingsFixture LaunchSettingsFixture { get; }

        public ServerTests(LaunchSettingsFixture launchSettingsFixture)
        {
            LaunchSettingsFixture = launchSettingsFixture;
        }
