...
{
    public class ResponseHeaderTests : IDisposable, IClassFixture<LaunchSettingsFixture>
    {
        private HttpClient _client = new HttpClient();
        private readonly LaunchSettingsFixture launchSettingsFixture;

        public ResponseHeaderTests(LaunchSettingsFixture launchSettingsFixture)
        {
