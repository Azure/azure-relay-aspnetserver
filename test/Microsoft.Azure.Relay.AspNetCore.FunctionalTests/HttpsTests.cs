...
{
    public class HttpsTests : IClassFixture<LaunchSettingsFixture>
    {
        private string Address = Utilities.GetRelayUrl();
        private readonly LaunchSettingsFixture fixture;

        public HttpsTests(LaunchSettingsFixture fixture)
        {
